...
public class AdminCategoryController {
    ...
    public String addCreatedNewMerch(Model model, @ModelAttribute("newCategory") Category newCategory, @RequestParam("imageBase64") MultipartFile imageBase64) throws IOException {
